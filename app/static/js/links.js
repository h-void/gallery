...
function renderArtistLinks() {
  ...
  // Entry stays hidden while loading, on error, and when the artist has no
  // indexed content: the list is derived from scanned documents, so there is
  // nothing to open and no manual add path behind this dialog.
